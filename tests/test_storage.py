...
class TestExtractTagsFromTitle:
    ...
    def test_multiple_hashtags(self) -> None:
        tags = extract_tags_from_title("#Python #TUI: neues Widget bauen")
    ...
    def test_hashtag_lowercase(self) -> None:
        tags = extract_tags_from_title("#React #NextJS App")
        assert tags == ["react", "nextjs"]

    def test_hashtag_mid_sentence(self) -> None:
        tags = extract_tags_from_title("Fix fuer #Sitefinity Bug in #Backend")
        assert tags == ["sitefinity", "backend"]
